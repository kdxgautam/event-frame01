    ...
    <>
      ...
      <div className="flex w-full justify-center items-center mt-28 pt-[70px] ">
        ...
        <div className="w-1/2 items-center flex justify-center h-3/4 pr-[2vw]">
          <img className="absolute opacity-0 md:opacity-100 md:relative  md:top-[-15vw] md:right-[-120px] max-w-full " src="/images/vector.png" alt="vector image" />
          <img className="max-w-full " src="/images/robot.png" alt="robot" />
          <img className="absolute opacity-0 md:opacity-100 md:relative  md:top-[100px] max-w-full" src="/images/vector2.png" alt="vector image" />
        </div>
